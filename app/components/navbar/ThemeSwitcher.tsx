  ...
  return (
    <div className="dropdown dropdown-end">
      <div
        tabIndex={0}
        role="button"
        className="btn btn-ghost rounded-2xl flex items-center gap-2 hover:bg-base-200"
      >
      ...
      <ul
        tabIndex={0}
        className="dropdown-content z-[100] menu p-2.5 shadow-2xl bg-base-200 rounded-3xl w-48 gap-1.5 mt-2"
      >
            ...
            <li key={theme.id}>
              ...
              >
                <div className="flex items-center gap-2">
                  <div className="flex items-center gap-0.5 p-0.5 rounded-md bg-base-300">
