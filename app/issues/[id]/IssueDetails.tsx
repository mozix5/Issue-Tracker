...
const IssueDetails = ({ issueDetails }: { issueDetails: Issue }) => {
  return (
    <div className="w-full bg-base-200 shadow-xl rounded-3xl p-6 flex-1">
      <div className="">
      ...
      <div className="p-6 mt-8 rounded-2xl bg-base-100 min-h-20 leading-relaxed prose max-w-none">
